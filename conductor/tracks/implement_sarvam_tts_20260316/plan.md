...
- [x] Task: Implement Sarvam API call in `sarvam_tts.py`. 21c0547
...
- [x] Task: Conductor - User Manual Verification 'Phase 2: TTS Implementation' (Protocol in workflow.md) [checkpoint: 21c0547]
